...
def date(main_url):
	...
	for word in url1.split():
		if(("200" in word or "201" in word) and int(word.split('-')[0]) == 2005):
			yr.append(word)
	return yr	
	#print(yr)
...
def main():
	...
	sundata_list = sun(main_url, '2005-03')
	for sundata in sundata_list:
		# print(sundata + " " + time_frame + "\n")
		runForSunData(main_url, '2005-03', sundata)
	
	
	with open('month2005_3.json', 'w') as outfile:
		json.dump(mon, outfile)	
